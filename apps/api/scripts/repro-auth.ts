...
new Elysia().use(createApp(manifest)).listen({ port: 3313, hostname: '127.0.0.1' });
console.log('repro-min on :3311');

import { auth } from "../src/auth/auth";
console.log("auth attached", typeof auth.api.getSession);
